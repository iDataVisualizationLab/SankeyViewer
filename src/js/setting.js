...
// Quanah new
serviceListattr = ['CPU1_Temp', 'CPU2_Temp', 'Inlet_Temp', 'FAN_1', 'power_consumption'];
var serviceLists = [{"text":"CPU1_Temp","id":0,"enable":true,"sub":[{"text":"CPU1_Temp","id":0,"enable":true,"idroot":0,"angle":0,"range":[3,98]}]},{"text":"CPU2_Temp","id":1,"enable":true,"sub":[{"text":"CPU2_Temp","id":0,"enable":true,"idroot":1,"angle":1.2566370614359172,"range":[3,98]}]},{"text":"Inlet_Temp","id":2,"enable":true,"sub":[{"text":"Inlet_Temp","id":0,"enable":true,"idroot":2,"angle":2.5132741228718345,"range":[3,98]}]},{"text":"FAN_1","id":3,"enable":true,"sub":[{"text":"FAN_1","id":0,"enable":true,"idroot":3,"angle":3.7699111843077517,"range":[1050,17850]}]},{"text":"power_consumption","id":4,"enable":true,"sub":[{"text":"power_consumption","id":0,"enable":true,"idroot":4,"angle":5.026548245743669,"range":[0,400]}]}];
